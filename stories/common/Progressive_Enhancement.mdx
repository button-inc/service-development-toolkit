import button_card_html from './img/button-card-html.png'
import button_card_js from './img/button-card-js.png'
import bcgov_card_html from './img/bcgov-card-html.png'
import bcgov_card_js from './img/bcgov-card-js.png'
...
export const getImageByTheme = (theme) => {
  if (theme === 'bcgov') {
    return {
      html: bcgov_card_html,
      js: bcgov_card_js,
    }
  }
  return {
    html: button_card_html,
    js: button_card_js,
  }
}
...
<div className="images-container">
  <div className="image-container">
    <img src={getImageByTheme(props.theme).html} style={{width: '512px'}} alt="Card component in plain html" />
    Plain HTML
  </div>
  <div className="image-container">
    <img src={getImageByTheme(props.theme).js} style={{width: '512px'}} alt="Card component with css & javascript applied" />
    With JavaScript + CSS
  </div>
</div>
