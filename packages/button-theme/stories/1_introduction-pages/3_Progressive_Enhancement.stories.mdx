...
import btn_html from '../img/btn-html.png'
import btn_css from '../img/btn-css.png'
...
<div className="images-container">
  <div className="image-container">
    <img src={btn_html} style={{width: '256px'}} alt="Button in plain html" />
    Plain HTML
  </div>
  <div className="image-container">
    <img src={btn_css} style={{width: '256px'}} alt="button with css applied" />
    With JavaScript + CSS
  </div>
</div>
